function scanDriveAndReply() {
    ...
    var folderName = 'YOUR_FOLDER_NAME'; // Name of the folder containing payment proofs
    var dayLimit = 30; // Limit search to emails from the last X days
    var senderName = 'John Doe'; // Your name to be included in the email reply
    var timeZone = Session.getScriptTimeZone(); // Your time zone, default is script's time zone
    ...
    // Set date limit based on the day limit
    var dateLimit = new Date();
    dateLimit.setDate(dateLimit.getDate() - dayLimit);
    var formattedDate = Utilities.formatDate(dateLimit, timeZone, 'yyyy/MM/dd');

    var searchQuery = 'in:inbox subject:(' + invoiceString + ') after:' + formattedDate;
            ...
            if (invoicesToProcess.length > 0) {
                ...
                if (attachments.length > 0) {
                    ...
                    var body = "Dear Mr./Mrs.,\n\n" +
                        ...
                        "Thank you.\n\n" +
                        "Best regards,\n" +
                        senderName; // Use the customizable sender name
